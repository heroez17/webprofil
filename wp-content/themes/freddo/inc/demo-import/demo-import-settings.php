	...
	function freddo_ocdi_import_files() {
	  return array(
		array(
		  ...
		  'local_import_file'            => trailingslashit( get_template_directory() ) . 'inc/demo-import/freddo-content-demo.xml',
		  'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'inc/demo-import/freddo-customizer-demo.dat',
